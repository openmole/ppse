...
In 2015 and we introduced PSE. 
It has been widely used to discover new insights on simulation models in various application fields such as CITATIONS. 
This method is efficient to list possible pattern but does not provide any information about the plausibility of the discovered pattern. To overcome this limitation we designed a new exploration method called Pattern Probability Space Estimation (PPSE). 
...
For the sake of simplicity we consider here that the input parameters of the model are defined on $[0, 1]$.
