...
The idea behind the PPSE algorithm is to evolutionally bias the sampling of the parameter space towards the part generating rare pattern, while keeping the enough knoledge on this bias to be de-bias the results and obtain unbiased estimator of the pattern likelihoods.
